...
from announcements.review.models import Base as ReviewBase
...
config.set_section_option(section, 'DB_ENGINE', settings.DATA_BASE.DB_ENGINE)
...
target_metadata = ReviewBase.metadata
